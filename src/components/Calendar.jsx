...
// Fonzie: mayb we can take note of where this is called and instead use the data from firebase? 
const defaultEvents = [{
    id: 1,
    ...
    id: 2,
    start: '2022-12-03T15:00',
    end: '2022-12-03T16:00',
    ...
    id: 3,
    start: '2022-12-02T18:00',
    end: '2022-12-02T22:00',
    title: 'Dexter BD',
    description: '',
    allDay: false,
    free: true,
    ...
    id: 4,
    start: '2022-12-04T10:30',
    end: '2022-12-04T11:30',
...
// use these CRUD functions in Calendar() where they are required 
/*
...
1. Create
    const createEvent = async () => {
        await addDoc(eventsCollectionRef, {Title: newTitle, Description: newDescription})
    } 
2. Read
    useEffect(()=>{
    ...
    // above [means that if a change is detected in events it will re-render!!]
...
4. Update
    ...
    // await updateDoc(eventDoc,newTitle)
    // await updateDoc(eventDoc,newDescription)
    console.log(id +" : "+ title + " : " + description)
  }
*/
//
function Calendar() {
    // Fonzie: firestores event colletcion, use 'eventsCollectionRef' to refer to it in the code
    ...
    // Fonzie: we save the event that we are making via the popup menu
